...
- (void)getNote {
    ...
    [[EvernoteNoteStore noteStore] findNotesMetadataWithFilter:filter offset:self.currentNote maxNotes:100 resultSpec:resultSpec success:^(EDAMNotesMetadataList *metadata) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [noteStore getNoteTagNamesWithGuid:note.guid success:^(NSArray *names){
        ...
        NSLog(@"Faaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaack %@", cell.LabelTag1.text);
